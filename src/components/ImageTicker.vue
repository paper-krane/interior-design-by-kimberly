...
// Images
import image1 from '@/assets/images/ticker-001.webp';
import image2 from '@/assets/images/ticker-002.webp';
import image3 from '@/assets/images/ticker-003.webp';
import image4 from '@/assets/images/ticker-004.webp';
...
<template>
    <section class="pk__image-ticker_section pk__section-margin-top pk__section-margin-bot" ref="gallerySection">
        <div class="pk__container pk__image-ticker_header">
            ...
            <a href="https://www.instagram.com/interiordesignbykimberly" target="_blank">
                @interiordesignbykimberly
            </a>
        </div>
